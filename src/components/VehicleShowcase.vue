  ...
  <div class="w-full max-w-6xl mx-auto px-4 py-8" id="vehicles">
    ...
    <div v-else>
      ...
      <p class="text-center text-gray-400 text-[10px] mt-6 max-w-4xl mx-auto opacity-75">
        *ราคานี้มีผลตั้งแต่ 22 ตุลาคม 2568 เป็นต้นไป | ราคารวมภาษีมูลค่าเพิ่มแล้ว แต่ยังไม่รวมค่าประกันและอุปกรณ์ตกแต่ง
        <br>ภาพรถยนต์ที่ปรากฏเป็นภาพจำลองเพื่อการโฆษณา สีของรถอาจแตกต่างจากของจริงที่หน้าโชว์รูม ขึ้นอยู่กับการตั้งค่าหน้าจอ
      </p>
    </div>
  </div>
</template>
